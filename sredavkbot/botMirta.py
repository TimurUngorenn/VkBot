...
session = vk_api.VkApi(
    token='vk1.a.bjkW2iBFTLi3mxK1aPVCpR72xxB_nNvwafUN7vX0TH02kx72E1E24hBF5VquCL8Gr4G-t-XuKV8sk3zUvcQKH3toipmQOBO6WemNQtXjediAH3YGJriKKTDTcsnfGy8cYbAINrHV4M4bNTbqgRXZvnYQ07-jqYxQ1bE2Xb3c1xNyN_2zYf2ZNv_pRqAvlVGc1i7XmwojHZapOUqYtV9H3g')
        ...
        if event.type == VkEventType.MESSAGE_NEW:
            ...
            if event.from_user and not event.from_me:
                if response.find("привет") >= 0 or response.find('здравствуй') >= 0:
                    ...
                    time.sleep(random.uniform(0.5, 2.0))
                    session.method('messages.send', {'user_id': event.user_id,
                                                     'message': 'ты скорее всего чем я потому что я не рялин ', 'random_id': 0})
